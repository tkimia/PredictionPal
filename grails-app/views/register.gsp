...
<body>
	<div id="reg-form">
		...
		<g:if test="${params.s=='1'}">
			<h3 align="center"> Please enter a password</h3>
		</g:if>
		<g:elseif test="${params.s=='2'}">
			<h3 align="center"> Passwords must match</h3>
		</g:elseif>
		<g:elseif test="${params.s=='3'}">
			<h3 align="center"> User name in use</h3>
		</g:elseif>
			<fieldset id="login_fieldset">	
				<g:textField name="user_name" class="reg-button" placeholder="username" required value="${user_name}"/>
				<g:textField name="pass_word1" class="reg-button" placeholder="password" required value="${pass_word1}"/>
				<g:textField name="pass_word2" class="reg-button" placeholder="repeat password" required value="${pass_word2}"/>
